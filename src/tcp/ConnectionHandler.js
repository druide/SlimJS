...
function ConnectionHandler () {
  ...
  function tryToParseLengthHeader () {
    if (payloadLengthHeaderHasArrived()) parseLengthHeader()
  }
  ...
  function tryToParsePayloadBody () {
    if (payloadBodyHasArrived()) executeInstructionSet()
  }
  ...
  function executeInstructionSet (t) {
    ...
    var instruction
    if (instructionData === BYE) instruction = BYE
    else instruction = slimParser.parse(instructionData)
